  ...
  return (
    <div className="mx-4 mb-3 bg-white rounded-2xl border border-[#e5e5e5] p-4 animate-fade-in">
      <div className="flex items-start justify-between mb-3">
        <p className="text-sm font-semibold text-[#1f1c2f]">Compartir evidencia (opcional)</p>
      ...
      <div className="grid grid-cols-2 gap-2 mb-3">
        ...
        >
          ...
          <span className="text-xs text-[#676d65] font-medium">Foto de negocio</span>
        </button>
        <button
          onClick={onUpload}
          className="flex flex-col items-center gap-2 p-3 rounded-xl border-2 border-dashed border-[#d8d4c3] touch-active active:border-[#1a989e]"
        >
          ...
          <span className="text-xs text-[#676d65] font-medium">Documento</span>
        </button>
      </div>
