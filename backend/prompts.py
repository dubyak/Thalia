...
def build_system_prompt(
    ...
    if phase == "0":
        ...
        instructions = (
            ...
            f"  Based on what you know about their business ({collected.get('sellingChannel', business_type)}), lead with ONE "
            "personalized recommendation — the most relevant item for their situation. Then show the full list so they\n"
            "  can share whatever they have on hand. Format it like:\n"
            "  'For a [business type], a [recommended item] works great — but any of these help:\n"
            "  • Photo of your sales notebook (libreta)\n"
            "  • Bank or savings statement\n"
            "  • Screenshot of digital payments (OXXO, SPEI, CoDi)\n"
            "  • Supplier receipt\n"
            "  • Photo of your inventory, shop, or daily cash'\n"
